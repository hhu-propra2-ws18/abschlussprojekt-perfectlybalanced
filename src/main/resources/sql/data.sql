...
INSERT INTO PRODUCT_ENTITY(title,description,cost,street,housenumber,postcode,city,surety,owner_user_id)
VALUES('Zange','Um Nägel rauszuziehen',20,'Universiätsstraße',2,40225,'Düsseldorf',5,3);

INSERT INTO PRODUCT_ENTITY(title,description,cost,street,housenumber,postcode,city,surety,owner_user_id)
VALUES('Akkubohrer','Um Löcher zu bohren',25,'Universiätsstraße',2,40225,'Düsseldorf',10,4);

INSERT INTO PRODUCT_ENTITY(title,description,cost,street,housenumber,postcode,city,surety,owner_user_id)
VALUES('Säge','Um zu sägen',15,'Universiätsstraße',5,40225,'Düsseldorf',4,2);

INSERT INTO LENDING_ENTITY(start,end,status,borrower_user_id,product_id,surety_reservationid,cost_reservationid)
VALUES('2019-02-12 12:00:00','2019-02-14 12:00:00', 4, 3, 1, 1, 1);

INSERT INTO LENDING_ENTITY(start, end, status,borrower_user_id,product_id,surety_reservationid,cost_reservationid)
VALUES('2019-02-11 12:00:00','2019-02-12 12:00:00', 3, 1, 3, 1, 1);

INSERT INTO LENDING_ENTITY(start,end,status,borrower_user_id,product_id,surety_reservationid,cost_reservationid)
VALUES('2019-02-11 12:00:00','2019-02-12 12:00:00', 0, 1, 2, 1, 1);

INSERT INTO LENDING_ENTITY(start,end,status,borrower_user_id,product_id,surety_reservationid,cost_reservationid)
VALUES('2019-02-13 12:00:00','2019-02-16 12:00:00', 2, 4, 3, 1, 1);

INSERT INTO LENDING_ENTITY(start,end,status,borrower_user_id,product_id,surety_reservationid,cost_reservationid)
VALUES('2019-02-11 12:00:00','2019-02-12 12:00:00', 1, 2, 4, 1, 1);