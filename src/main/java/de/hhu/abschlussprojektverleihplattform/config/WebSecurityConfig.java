...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public void globalSecurityAuthentification(AuthenticationManagerBuilder auth)
	throws Exception {
	auth
    ...
    *   - Zugriffsrechte (ADMIN, USER) oder getrennte Bereiche
    *     (User für Plattform, Admin für Konflikt)
